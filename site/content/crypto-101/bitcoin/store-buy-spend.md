...
<div class="container my-3">
  <div class="row text-center mb-3">
    <div class="col">
     	...
     	<p class="small">A sequence of characters of 26-35 characters that holds Bitcoin. The amount of Bitcoins kept on any public address is available on the blockchain</p>
    </div>
    <div class="col">
     	{{< img src="crypto-101/icons/key.svg" class="img-fluid" alt="Key" >}}
     	<p class="font-weight-bold">Private key</p>
     	<p class="small">A sequence of characters that proves to the network that you are the owner of a public address's balance</p>
    </div>
    <div class="col">
...
<div class="container my-4">
  <div class="row align-items-center">
    ...
    <div class="col-8 text-left">
      ...
      <p>When a transaction is issued, the network performs a mathematical algorithm to verify whether the pair is correct. If a private key is made public then the funds are compromised - as anyone could make a transaction.</p>
...
<p class="font-weight-bold text-center mt-5">Let's compare fiat with Bitcoin:</p>
...
<div class="container my-4">
  ...
  <div class="row text-center small">
    ...
    <div class="col">
      ...
      <p>No intermediary, and no one can seize funds without private keys.</p>
    </div>
  </div>
</div>
...
Purchasing Bitcoin has become easier by the day, thanks its exponential market penetration.

<div class="container my-5">
  <div class="row align-items-center">
    <div class="col text-left">
     	<h3>Exchange</h3>
      Just like the stock and bond market exchange, you can buy cryptocurrencies on a specialised cryptocurrency exchange. An exchange acts as a centralised marketplace and lets you trade fiat with cryptocurrencies at a given rate - decided by the market.
    </div>
...
<div class="container my-5">
  <div class="row align-items-center">
    ...
    <div class="col text-left">
    	<h3>ATM</h3>
      Purchase Bitcoins with new generation cryptocurrency ATMs. These kiosks are located in major urban hubs and allow you to purchase Bitcoins without going through any Know Your Customer (KYC) verification.
    </div>
  </div>
</div>
...
<div class="container my-5">
  <div class="row align-items-center">
    <div class="col text-left">
      ...
      As opposed to centralised exchanges, you can join a dealers network and purchase Bitcoins over-the-counter. This method is useful for large bulk purchases.
    </div>
    <div class="col text-center">
...
Today, everything can be purchased with Bitcoin.
...
<div class="container my-5">
  <div class="row align-items-center">
    <div class="col text-left">
    	<h3>Marketplace</h3>
    	<p>At first, Bitcoin transactions kicked off on the Dark web, used by illegal marketplaces and gambling platforms. Today, the majority of them are still operational, enabling the purchase of illicit products, including narcotics or weapons.</p>
